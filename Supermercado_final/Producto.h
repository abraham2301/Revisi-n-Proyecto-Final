...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			string insertar = "INSERT INTO productos (Producto,id_Marca,Descripcion,Imagen,Precio_Costo,Precio_Venta,Existencia,Fecha_Ingreso) VALUES ('" + producto + "'," + idmar + ",'" + Descripcion + "','" + Imagen + "'," + precicos + "," + precioven + "," + exist + ",'" + fecha_ingreso + "');";
