...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			string insertar = "INSERT INTO clientes (Nombres,Apellidos,NIT,genero,telefono,Correo_Electronico,Fecha_Ingreso) VALUES ('" + nombres + "','" + apellidos + "','" + nit + "'," + gene + ",'" + telefono + "','" + correo_electronico + "','" + fechaingreso + "');";
