...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			string insertar = "INSERT INTO empleados (Nombres,Apellidos,Direccion,Telefono,DPI,Fecha_Nacimiento,id_Puesto,Fecha_Inicio_Labores,Fecha_Ingreso) VALUES ('" + nombres + "','" + apellidos + "','" + direccion + "','" + telefono + "','" + DPI + "','" + fecha_nacimiento + "'," + idpues + ",'" + fecha_inicio_labores + "','" + fecha_ingreso + "');";
